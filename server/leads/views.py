...
from leads.serializers import UserSessionSerializer
...
class UserAccountRetrieveUpdateDestroy(generics.RetrieveUpdateDestroyAPIView):
  queryset = User_Session.objects.all()
  serializer_class = UserAccountSerializer

class UserSessionRetrieveUpdateDestroy(generics.RetrieveUpdateDestroyAPIView):
